...
{
    public static class FamilyTreeDatabaseHelper
    {
        internal static DbContextOptions<FamilyTreeContext> GetFamilyTreeContextInMemoryOptions()
        {
            return new DbContextOptionsBuilder<FamilyTreeContext>().UseInMemoryDatabase("FamilyTreeDatabase").Options;
        }
        ...
        internal static List<Person> _personList = new List<Person>
        {
        ...
        internal static List<Couple> _coupleList = new List<Couple>
        {
        ...
        internal static List<Child> _childList = new List<Child>
        {
